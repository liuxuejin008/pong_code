                  ...
                  <div class="sm:mx-auto sm:w-full sm:max-w-md bg-white p-10 rounded-xl shadow-xl border border-gray-100">
                    ...
                    <form class="space-y-6" onsubmit="app.handlers.login(event)">
                      <div>
                        ...
                        <input name="username" data-testid="login-username-input" required class="block w-full rounded-lg border-gray-300 py-2.5 text-gray-900 shadow-sm focus:ring-2 focus:ring-primary-500 focus:border-primary-500 sm:text-sm px-3 bg-gray-50 border hover:bg-white transition-colors">
                      </div>
                      <div>
                        <div class="flex items-center justify-between mb-2">
                          <label class="block text-sm font-medium leading-6 text-gray-900">密码</label>
                        </div>
                        <input name="password" type="password" data-testid="login-password-input" required class="block w-full rounded-lg border-gray-300 py-2.5 text-gray-900 shadow-sm focus:ring-2 focus:ring-primary-500 focus:border-primary-500 sm:text-sm px-3 bg-gray-50 border hover:bg-white transition-colors">
                      </div>
                      <div>
                        <button type="submit" data-testid="login-submit-button" class="flex w-full items-center justify-center gap-2 rounded-lg bg-primary-600 px-3 py-2.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-primary-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary-600 transition-all transform active:scale-95">
               ...
               <div class="flex min-h-screen flex-col justify-center px-6 py-12 lg:px-8 bg-gray-50">
                  <div class="sm:mx-auto sm:w-full sm:max-w-md bg-white p-10 rounded-xl shadow-xl border border-gray-100">
                    ...
                    <form class="space-y-5" onsubmit="app.handlers.register(event)">
                      <div>
                        <label class="block text-sm font-medium leading-6 text-gray-900 mb-2">用户名</label>
                        <input name="username" data-testid="register-username-input" required class="block w-full rounded-lg border-gray-300 py-2.5 text-gray-900 shadow-sm focus:ring-2 focus:ring-primary-500 focus:border-primary-500 sm:text-sm px-3 bg-gray-50 border hover:bg-white transition-colors">
                      </div>
                      <div>
                        <label class="block text-sm font-medium leading-6 text-gray-900 mb-2">电子邮箱</label>
                        <input name="email" type="email" data-testid="register-email-input" required class="block w-full rounded-lg border-gray-300 py-2.5 text-gray-900 shadow-sm focus:ring-2 focus:ring-primary-500 focus:border-primary-500 sm:text-sm px-3 bg-gray-50 border hover:bg-white transition-colors">
                      </div>
                      <div>
                        <label class="block text-sm font-medium leading-6 text-gray-900 mb-2">密码</label>
                        <input name="password" type="password" data-testid="register-password-input" required class="block w-full rounded-lg border-gray-300 py-2.5 text-gray-900 shadow-sm focus:ring-2 focus:ring-primary-500 focus:border-primary-500 sm:text-sm px-3 bg-gray-50 border hover:bg-white transition-colors">
                      </div>
                      <div>
                        <button type="submit" data-testid="register-submit-button" class="flex w-full items-center justify-center gap-2 rounded-lg bg-primary-600 px-3 py-2.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-primary-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary-600 transition-all transform active:scale-95">
